...
Experiment & Stage & N_{bolometers} & Noise (Temperature) & Noise(polarisation)  \\ \hline
SPT-pol & \multicolumn{1}{c|}{2} & \multicolumn{1}{c|}{1536} & \multicolumn{1}{c|}{14} & \multicolumn{1}{c}{20} \\
SPT-3G & \multicolumn{1}{c|}{3} & \multicolumn{1}{c|}{15234} & \multicolumn{1}{c|}{3.4} & \multicolumn{1}{c}{4.8} \\
 &  &  &  & 
\end{tabular}
\end{table}
