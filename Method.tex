...
To ensure that the derivatives are accurate the stepsizes must be small, however if the step size is too small, the derivatives are subject to numerical artifacts. To ensure that I chose a well-conditioned step size I plotted $\Delta C_{\ell}$ for a variety of step-sizes. When looking for a good step size, I want to see:
...
\end{enumerate}
For illustrative purposes I will show some examples of $\Delta C_{\ell}$ plots and explain how I chose my step sizes.

\begin{figure}
\centering
\includegraphics[scale=0.5]{images/H0.png}
\caption{placeholder}
\end{figure}

\begin{figure}
\centering
\includegraphics[scale=0.5]{images/H0zoomed.png}
\caption{placeholder}
\end{figure}
